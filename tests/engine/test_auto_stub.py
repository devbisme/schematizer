...
gen_schematic = importlib.import_module("schematizer.engine.gen_schematic")
...
class TestRowBasedPlacer:
    ...
    def test_threshold_constant_exists(self):
        ...
        from schematizer.engine.place import Placer
...
class TestBoundaryNets:
    ...
    def test_boundary_nets_method_exists(self):
        ...
        from schematizer.engine.sch_node import SchNode
...
class TestHierarchicalLabels:
    ...
    def test_hierarchical_label_function_exists(self):
        ...
        from schematizer.engine.sexp_schematic import hierarchical_label_to_sexp
...
class TestSharedIcPinFan:
    ...
    def _snap_geometry_for_ic_pin(self, output_dir):
        ...
        # Schematic generation is delegated to the 'schematizer' package, so the
        # snap pass that actually runs lives in its vendored engine.
        from schematizer.engine import snap as snap_mod
        ...
        from schematizer.engine import gen_schematic as gs
