...
from ..ir import SchPart as Part, SchPin as Pin
...
class NetTerminal(Part):
    def __init__(self, net, tool_module):
        ...
        # Create a Part attached to the net's circuit (which assigns its ref).
        super().__init__(name="NT", ref_prefix="NT", tool=None, circuit=net.circuit)
