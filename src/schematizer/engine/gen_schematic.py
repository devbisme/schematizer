...
# Which KiCad version this engine targets. ``render`` sets it before calling
# ``gen_schematic`` so the (tiny) per-version output toggles apply.
TARGET_TOOL = "kicad9"
...
def _setup_kicad_env():
    ...
    """
    kicad_version = TARGET_TOOL[len("kicad") :]
